...
<!--Conteúdo-->
   <main>
        <div class="jumbotron">
           ...
           <p class="lead">Na Full Stack Eletro programadorxs tem desconto em todos os produtos.</p>
           <hr class="my-4 bg-primary">
           <p>Temos os melhores produtos e os melhores preços. </p>
 
            <a class="btn btn-info btn-lg" href="produtos.php" role="button">Boas Compras!</a>
        </div>
           
        <hr>
            
        <div class="container">
            <img src="./img/produtos.jpg" alt="Eletrodomésticos">
        </div>
        <br>
    </main>
        <hr>
